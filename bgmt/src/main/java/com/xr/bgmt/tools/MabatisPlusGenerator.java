...
public class MabatisPlusGenerator {
    //生成文件所在项目路径
    private static String baseProjectPath = "D:\\homeworkspace\\workserver\\bgmt";

    //基本包名
    private static String basePackage="com.xr";
    //作者
    private static String authorName="yanwei";
    //要生成的表名
    private static String[] tables= {"t_ws_kpi_relation"};
    //table前缀
    private static String prefix="t_";

    //数据库配置四要素
    private static String driverName = "com.mysql.cj.jdbc.Driver";
    private static String url = "jdbc:mysql://106.13.231.226:3306/xr_work_server?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
